### Main code used in manuscript "Intense Storms Increase Global Ice Area"

- Cyclone Identification scripts (based on ERA5 data): cyclone_tracker4.py, aa_cyclone_tracker1.py
